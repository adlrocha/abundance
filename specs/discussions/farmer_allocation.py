...
scenarios = [
   {
        "name": "Nazar 10 Shards",
        "num_shards": 10,
        "max_plot_size_gib": 64000, # TODO: This may be gamable due to how piece selection works.
        "total_network_storage_pib": 500,
        "plotting_throughput_tib_hr_per_attacker": 1000,
        "attacker_storage_percentage": 1,
        "cost_per_plot_usd": 0.25, # 3.6T an hour for 1 plot?
        "target_reshuffle_interval_hours": 1
    },
   {
        "name": "Nazar 100 Shards",
        "num_shards": 3,
        "max_plot_size_gib": 64000, # TODO: This may be gamable due to how piece selection works.
        "total_network_storage_pib": 500,
        "plotting_throughput_tib_hr_per_attacker": 1000, # TODO: Depending on the size of the networking there may be a networking bottleneck of downloading the history and keeping it in memory to plot.
        "attacker_storage_percentage": 1,
